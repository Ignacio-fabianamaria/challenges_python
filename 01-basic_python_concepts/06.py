...
def travel_by_plane(distance):
    ...
    hours, rest = divmod(time_hours * 3600, 3600) # Obtendo as horas e segundos restantes
...
def travel_by_car(distance):
    ...
    hours, rest = divmod(time_hours * 3600, 3600) # Obtendo as horas e segundos restantes
    min, sec = divmod(rest, 60) # Obtendo minutos e segundos com o valor remanescente do calculo anterior
