...
def classify_student():
    try:
        while True:
            student_score = float(input('Por favor insira sua pontuação para verificar seu status no exame. \n'
            ...
            if 11 > student_score >= 7:
                ...
                print(f'Pontuação alcançada de {student_score} é insucifiente para aprovação.\nREPROVADO!')
                break
            else:
